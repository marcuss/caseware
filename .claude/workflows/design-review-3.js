export const meta = {
  ...
  description: 'Adversarial review round 3 over the design document (staff-level signal, sharp decisions and the page limit), followed by a revision',
  whenToUse: 'Run after round 2 has been committed, last before humanizing. Takes no args; the round number is fixed in this script.',
  phases: [
