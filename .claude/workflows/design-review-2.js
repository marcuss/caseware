export const meta = {
  ...
  description: 'Adversarial review round 2 over the design document (the arithmetic, scale, cost and failure recovery), followed by a revision',
  whenToUse: 'Run after round 1 has been committed. Takes no args; the round number is fixed in this script.',
  phases: [
